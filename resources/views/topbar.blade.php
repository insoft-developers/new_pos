...
<div class="navbar-custom">
    <div class="topbar">
        <div class="topbar-menu d-flex align-items-center gap-lg-2 gap-1">
            ...
            <div class="logo-box">
                ...
                <a href="index.html" class="logo-light">
                    <img src="{{ asset('template') }}/assets/images/logo-light.png" alt="logo" class="logo-lg"
                        height="20">
                    <img src="{{ asset('template') }}/assets/images/logo-sm.png" alt="small logo" class="logo-sm"
                        height="20">
                </a>

                <!-- Brand Logo Dark -->
                <a href="index.html" class="logo-dark">
                    <img src="{{ asset('template') }}/assets/images/logo-dark.png" alt="dark logo" class="logo-lg"
                        height="20">
                    <img src="{{ asset('template') }}/assets/images/logo-sm.png" alt="small logo" class="logo-sm"
                        height="20">
                </a>
        ...
        <ul class="topbar-menu d-flex align-items-center gap-2">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-dark arrow-none" data-bs-toggle="dropdown"
            ...
            <li class="dropdown d-none d-md-inline-block">
                <a class="nav-link dropdown-toggle waves-effect waves-dark arrow-none" data-bs-toggle="dropdown"
                    href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('template') }}/assets/images/flags/us.jpg" alt="user-image" class="me-0 me-sm-1"
                        height="18">
                </a>
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="{{ asset('template') }}/assets/images/users/avatar-4.jpg"
                                                class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
