...
<body>
    ...
    @php
        ...
        $tempoDisplay = 'Semua Tempo';
        if (!empty($tempo)) {
            if ($tempo == 'jatuh-tempo') {
                $tempoDisplay = 'Jatuh Tempo';
            }
        }

        $statusDisplay = 'Semua Status';
        if (!empty($status)) {
    ...
    <table class="table-piutang">
        ...
        <tbody>
            ...
            @forelse($piutang as $index => $row)

                @php

                    $belanja = (float) ($row->belanja ?? 0);
                ...
                <tr>
                    ...
                    <td>
                        {{ !empty($row->jatuh_tempo) ? date('d-m-Y', strtotime($row->jatuh_tempo)) : '' }}
                    </td>
