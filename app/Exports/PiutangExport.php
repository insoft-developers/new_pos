...
class PiutangExport implements
    FromCollection,
    WithHeadings,
    WithMapping,
    WithEvents,
    ...
    ShouldAutoSize
{
    ...
    public function map($row): array
    {
        ...
        $this->totalBelanja = $this->totalBelanja + $row->belanja ?? 0;
        $this->totalBayar = $this->totalBayar + $row->bayar ?? 0;
    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $tempo = $request->tempo == 'jatuh-tempo' ? 'Jatuh Tempo' : 'Semua';
